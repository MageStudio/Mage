/*! mage version: 0.0.73, 13-05-2017 */
function Class(a, b) {
...
function() {
    ...
    instance: function() {
        ...
        return a.prototype.generateMesh = function() {
            ...
            this.pingPhase = !0;
            for (var a = new window.Float32Array(this.resolution * this.resolution * 4), b = 0; b < this.resolution; b++) for (var c = 0; c < this.resolution; c++) a[b * this.resolution * 4 + 4 * c] = 2 * Math.random() * Math.PI, 
            ...
            return ocean = new a(b, c, d, {
                ...
                ocean.deltaTime = (a - lastTime) / 1e3 || 0, lastTime = a, ocean.update(ocean.deltaTime), 
                ...
                ocean.materialOcean.uniforms.u_cameraPosition.value = this.ms_Camera.position, ocean.materialOcean.depthTest = !0;
            }, ocean;
        };
    }()
}), Class("App", {
