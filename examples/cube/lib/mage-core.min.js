/*! mage version: 0.0.49, 02-04-2017 */
function Class(a, b) {
...
function() {
    ...
    instance: function(a, b, c, d) {
        ...
        return mirrorMesh = new THREE.Mesh(new THREE.PlaneBufferGeometry(500 * d.width, 500 * d.height), g.material), 
        mirrorMesh.add(g), mirrorMesh.rotation.x = .5 * -Math.PI, mirrorMesh;
    },
    options: {
        textureWidth: {
            name: "texture width",
