/*! mage version: 0.0.52, 02-04-2017 */
...
M.util.start = function() {
    ...
    ShaderMesh: function(a, b, c, d, e) {
        ...
        if (f.instance ? this.mesh = f.instance(app.renderer, app.camera.object, app.scene, e) : (c || (this.attributes = f.attributes), 
    ...
    load: function(a) {
        for (var b = 0; b < a.length; b++) {
            ...
            f.name.indexOf("_camera") > -1 ? M.loader.meshes._loadCamera(f, e) : M.loader.meshes._loadMesh(f, e, d);
        }
    },
    ...
    _loadMesh: function(a, b, c) {
        if (c && c.name && c.options) var d = new ShaderMesh({}, c.name, {}, {}, c.options); else {
            a.castShadow = !0, a.receiveShadow = !0;
            var d = new Mesh(a.geometry, a.material);
            if (d.mesh.position.set(a.position.x, a.position.y, a.position.z), d.mesh.rotation.set(a.rotation.x, a.rotation.y, a.rotation.z), 
            d.mesh.scale.set(a.scale.x, a.scale.y, a.scale.z), d.mesh.castShadow = !0, d.mesh.receiveShadow = !0, 
            current.textureKey) {
                var e = M.imagesEngine.get(current.textureKey);
                e.wrapS = THREE.RepeatWrapping, e.wrapT = THREE.RepeatWrapping, e.repeat.set(1, 1), 
                d.mesh.material.map = e;
            }
        }
        M.loader.meshes._attachScript(d, b);
    },
