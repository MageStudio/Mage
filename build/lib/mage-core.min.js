...
function() {
    ...
    instance: function(a, b, c, d) {
        ...
        var e = function(a, b, c, d) {
            ...
            var h = M.fx.shadersEngine.get("Mirror"), i = THREE.UniformsUtils.clone(h.uniforms);
            this.material = new THREE.ShaderMaterial({
        ...
        e.prototype = Object.create(M.fx.shadersEngine.get("Mirror").instance.prototype), 
        ...
        var g = new e(a, b, c, {
            ...
            waterNormals: f,
            alpha: d.alpha,
            sunDirection: d.light.position.clone().normalize(),
            sunColor: d.sunColor,
            waterColor: d.waterColor,
            distortionScale: d.distortionScale
        });
        return mirrorMesh = new Mesh(new THREE.PlaneBufferGeometry(500 * d.width, 500 * d.height), g.material), 
        mirrorMesh.addMesh(g), mirrorMesh.mesh.rotation.x = .5 * -Math.PI, mirrorMesh;
    },
    options: {
        textureWidth: {
            name: "texture width",
