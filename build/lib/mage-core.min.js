    ...
    instance: function(a, b, c, d) {
        ...
        e.prototype.constructor = e, e.prototype.updateTextureMatrix = function() {
            ...
            var g = new e(a, b, c, {
                ...
                waterNormals: f,
                alpha: d.alpha,
                sunDirection: d.light ? d.light.position.clone().normalize() : new THREE.Vector3(0, 0, 0).normalize(),
                sunColor: d.sunColor,
                waterColor: d.waterColor,
                distortionScale: d.distortionScale
            }), h = new Mesh(new THREE.PlaneBufferGeometry(500 * d.width, 500 * d.height), g.material);
            return h.addMesh(g), h.mesh.rotation.x = .5 * -Math.PI, h;
        };
    }(),
    options: {
        textureWidth: {
