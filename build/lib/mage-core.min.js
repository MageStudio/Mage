/*! mage version: 0.0.78, 23-05-2017 */
function Class(a, b) {
...
ParticleSystem.prototype.setValues = function(a) {
    if (void 0 !== a) {
...
}, ParticleSystem.prototype.randomValue = function(a, b) {
    return a + b * (Math.random() - .5);
}, ParticleSystem.prototype.randomVector3 = function(a, b) {
    ...
    this.mesh.dynamic = !0, this.mesh.sortParticles = !0;
    ...
    instance: function(a) {
        ...
        return c.setValues(b), c.initialize(), c;
    }
