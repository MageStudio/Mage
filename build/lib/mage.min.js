/*! mage version: 0.0.56, 29-04-2017 */
...
M.util.start = function() {
    ...
    ShaderMesh: function(a, b, c, d, e) {
        ...
        this.script = {}, this.hasScript = !1, this.mesh = new THREE.Mesh(a, f.material)) : this.mesh = f.instance(app.renderer, app.camera.object, app.scene, e), 
