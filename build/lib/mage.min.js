...
M.util.start = function() {
    ...
    scale: function(a) {
        var b = a.x || 1, c = a.y || 1, d = a.z || 1;
        this.mesh && this.mesh.scale.set(b, c, d);
    },
    position: function(a) {
        var b = a.x || this.mesh.position.x, c = a.y || this.mesh.position.y, d = a.z || this.mesh.position.z;
        this.mesh && this.mesh.position.set(b, c, d);
    },
    rotation: function(a) {
        var b = a.x || this.mesh.rotation.x, c = a.y || this.mesh.rotation.y, d = a.z || this.mesh.rotation.z;
        this.mesh && this.mesh.rotation.set(b, c, d);
    },
    add: function(a) {
        a.mesh && this.mesh && this.mesh.add(a.mesh);
    }
}), Class("Camera", {
    Camera: function(a) {
    ...
    texture: function(a) {
        a && this.mesh && this.mesh.material && (a.wrapS = THREE.RepeatWrapping, a.wrapT = THREE.RepeatWrapping, 
        a.repeat.set(1, 1), this.mesh.material.map = a);
    }
