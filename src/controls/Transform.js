...
export default class TransformControls extends Object3D {
    ...
    set parentQuaternion(value) {
        this.setAndDispatch("parentQuaternion", value);
    } // no
    get parentQuaternion() {
    ...
    pointerHover = pointer => {
        ...
        var intersect =
            this.ray.intersectObjects(this.gizmo.picker[this.mode].children, true)[0] || false;
    ...
    pointerMove = pointer => {
        ...
        if (space === "local")
            this.pointEnd.applyQuaternion(this.worldQuaternionStart.clone().invert());
        ...
        if (mode === "translate") {
            ...
            var quaternion =
                this.space === "local" ? this.worldQuaternion : this._identityQuaternion;
            ...
            if (axis === "E") {
                ...
                this.rotationAngle =
                    this.pointEnd.angleTo(this.pointStart) *
                    (this._tempVector.dot(this.eye) < 0 ? 1 : -1);
            } else if (axis === "XYZE") {
                this._tempVector
                    .copy(this.pointEnd)
                    .sub(this.pointStart)
                ...
                this.rotationAngle =
                    this.pointEnd.sub(this.pointStart).dot(this._tempVector.cross(this.eye)) *
                    ROTATION_SPEED;
                ...
                this.rotationAngle =
                    this._tempVector2.dot(this._tempVector.cross(this.eye).normalize()) *
                    ROTATION_SPEED;
            }
            ...
            if (space === "local") {
                ...
                object.quaternion.multiply(
                    this._tempQuaternion.setFromAxisAngle(this.rotationAxis, this.rotationAngle),
                );
            } else {
