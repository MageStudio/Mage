...
export default class Gizmo extends Object3D {
    ...
    getGizmoTranslate() {
        return {
            X: [
                [
                    new Mesh(this.arrowGeometry, this.matRed),
                    [1, 0, 0],
                    [0, 0, -Math.PI / 2],
                    null,
                    "fwd",
            ...
            Y: [
                ...
                [
                    new Mesh(this.arrowGeometry, this.matGreen),
                    [0, 1, 0],
                    [Math.PI, 0, 0],
                    null,
                    "bwd",
            ...
            Z: [
                [
                    new Mesh(this.arrowGeometry, this.matBlue),
                    [0, 0, 1],
                    [Math.PI / 2, 0, 0],
                    null,
                    "fwd",
            ...
            XYZ: [
                [
                    new Mesh(new OctahedronBufferGeometry(0.1, 0), this.matWhiteTransperent),
                    [0, 0, 0],
                    [0, 0, 0],
                ],
            ],
            XY: [
                [
                    new Mesh(new PlaneBufferGeometry(0.295, 0.295), this.matYellowTransparent),
                    [0.15, 0.15, 0],
                ],
                [
                    new Line(this.lineGeometry, this.matLineYellow),
                    [0.18, 0.3, 0],
                    null,
                    [0.125, 1, 1],
                ],
            ...
            YZ: [
                [
                    new Mesh(new PlaneBufferGeometry(0.295, 0.295), this.matCyanTransparent),
                    [0, 0.15, 0.15],
                    [0, Math.PI / 2, 0],
                ],
                [
                    new Line(this.lineGeometry, this.matLineCyan),
                    [0, 0.18, 0.3],
                    [0, 0, Math.PI / 2],
                    [0.125, 1, 1],
                ],
            ...
            XZ: [
                [
                    new Mesh(new PlaneBufferGeometry(0.295, 0.295), this.matMagentaTransparent),
                    [0.15, 0, 0.15],
                    [-Math.PI / 2, 0, 0],
                ],
                [
                    new Line(this.lineGeometry, this.matLineMagenta),
                    [0.18, 0, 0.3],
                    null,
                    [0.125, 1, 1],
                ],
    ...
    getPickerTranslate() {
        return {
            X: [
                [
                    new Mesh(new CylinderBufferGeometry(0.2, 0, 1, 4, 1, false), this.matInvisible),
                    [0.6, 0, 0],
                    [0, 0, -Math.PI / 2],
                ],
            ],
            ...
            XYZ: [[new Mesh(new OctahedronBufferGeometry(0.2, 0), this.matInvisible)]],
            XY: [[new Mesh(new PlaneBufferGeometry(0.4, 0.4), this.matInvisible), [0.2, 0.2, 0]]],
            YZ: [
                [
                    new Mesh(new PlaneBufferGeometry(0.4, 0.4), this.matInvisible),
                    [0, 0.2, 0.2],
                    [0, Math.PI / 2, 0],
                ],
            ],
    ...
    getHelperTranslate() {
        return {
            START: [
                [
                    new Mesh(new OctahedronBufferGeometry(0.01, 2), this.matHelper),
                    null,
                    null,
                    null,
                    "helper",
            ...
            DELTA: [
                [
                    new Line(this.createTranslateHelperGeometry(), this.matHelper),
                    null,
                    null,
                    null,
                    "helper",
            ...
            X: [
                [
                    new Line(this.lineGeometry, this.matHelper.clone()),
                    [-1e3, 0, 0],
                    null,
                    [1e6, 1, 1],
                    "helper",
    ...
    getGizmoRotate() {
        return {
            X: [
                ...
                [
                    new Mesh(new OctahedronBufferGeometry(0.04, 0), this.matRed),
                    [0, 0, 0.99],
                    null,
                    [1, 3, 1],
                ],
            ...
            Y: [
                [
                    new Line(this.createCircleGeometry(1, 0.5), this.matLineGreen),
                    null,
                    [0, 0, -Math.PI / 2],
                ],
                [
                    new Mesh(new OctahedronBufferGeometry(0.04, 0), this.matGreen),
                    [0, 0, 0.99],
                    null,
                    [3, 1, 1],
                ],
            ...
            Z: [
                [
                    new Line(this.createCircleGeometry(1, 0.5), this.matLineBlue),
                    null,
                    [0, Math.PI / 2, 0],
                ],
                [
                    new Mesh(new OctahedronBufferGeometry(0.04, 0), this.matBlue),
                    [0.99, 0, 0],
                    null,
                    [1, 3, 1],
                ],
            ...
            E: [
                [
                    new Line(this.createCircleGeometry(1.25, 1), this.matLineYellowTransparent),
                    null,
                    [0, Math.PI / 2, 0],
                ],
                [
            ...
            XYZE: [
                [
                    new Line(this.createCircleGeometry(1, 1), this.matLineGray),
                    null,
                    [0, Math.PI / 2, 0],
                ],
            ],
    ...
    getPickerRotate() {
        return {
            X: [
                [
                    new Mesh(new TorusBufferGeometry(1, 0.1, 4, 24), this.matInvisible),
                    [0, 0, 0],
            ...
            E: [[new Mesh(new TorusBufferGeometry(1.25, 0.1, 2, 24), this.matInvisible)]],
            XYZE: [[new Mesh(new SphereBufferGeometry(0.7, 10, 8), this.matInvisible)]],
        };
    }
    ...
    getGizmoScale() {
        return {
            X: [
                [
                    new Mesh(this.scaleHandleGeometry, this.matRed),
                    [0.8, 0, 0],
                    [0, 0, -Math.PI / 2],
                ],
            ...
            Y: [
                ...
                [
                    new Line(this.lineGeometry, this.matLineGreen),
                    null,
                    [0, 0, Math.PI / 2],
                    [0.8, 1, 1],
                ],
            ...
            Z: [
                [
                    new Mesh(this.scaleHandleGeometry, this.matBlue),
                    [0, 0, 0.8],
                    [Math.PI / 2, 0, 0],
                ],
                [
                    new Line(this.lineGeometry, this.matLineBlue),
                    null,
                    [0, -Math.PI / 2, 0],
                    [0.8, 1, 1],
                ],
            ...
            XY: [
                [
                    new Mesh(this.scaleHandleGeometry, this.matYellowTransparent),
                    [0.85, 0.85, 0],
                    null,
                    [2, 2, 0.2],
                ],
            ...
            YZ: [
                [
                    new Mesh(this.scaleHandleGeometry, this.matCyanTransparent),
                    [0, 0.85, 0.85],
                    null,
                    [0.2, 2, 2],
                ],
            ...
            XZ: [
                [
                    new Mesh(this.scaleHandleGeometry, this.matMagentaTransparent),
                    [0.85, 0, 0.85],
                    null,
                    [2, 0.2, 2],
                ],
            ...
            XYZX: [
                [
                    new Mesh(new BoxBufferGeometry(0.125, 0.125, 0.125), this.matWhiteTransperent),
                    [1.1, 0, 0],
                ],
            ],
            XYZY: [
    ...
    getPickerScale() {
        return {
            ...
            XY: [
                [
                    new Mesh(this.scaleHandleGeometry, this.matInvisible),
                    [0.85, 0.85, 0],
                    null,
                    [3, 3, 0.2],
                ],
