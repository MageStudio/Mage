	...
	Control = {
			...
			if (index != -1) {
				...
				switch (index) {
					case 0 : {
						...
						Control.fly( core.camera.object );
						Control.type = "fly";
						Control.oldType = 0;
						break;
					}
					case 1 : {
						...
						Control.fps( core.camera.object );
						core.add(Control.handler.getObject(), Control.handler);
		...
		fly : function () {
			...
			Control.handler = new Control.internal_fly( core.camera.object );
