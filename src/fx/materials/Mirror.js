...
export default class Mirror extends Object3D {
    ...
    constructor(renderer, camera, scene, options) {
        ...
        var mirrorColor =
            options.color !== undefined ? new Color(options.color) : new Color(0x7f7f7f);
    ...
    updateTextureMatrix() {
        ...
        q.x =
            (window.Math.sign(this.clipPlane.x) + projectionMatrix.elements[8]) /
            projectionMatrix.elements[0];
        q.y =
            (window.Math.sign(this.clipPlane.y) + projectionMatrix.elements[9]) /
