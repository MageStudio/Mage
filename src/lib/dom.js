...
export const getOrCreateElement = (selector, type, style) =>
    document.querySelector(selector) || createElementFromSelector(selector, type, style);

export const removeElement = selector => document.querySelector(selector).remove();

export const createElementFromSelector = (
    selector,
    type = "div",
    style = DEFAULT_FULL_SIZE_STYLE,
) => {
