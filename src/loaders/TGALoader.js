...
export default class TGALoader extends Loader {
    ...
    static tgaGetImageDataGrey8bits(
        header,
        imageData,
        y_start,
        y_step,
    ...
    static tgaGetImageDataGrey16bits(
        header,
        imageData,
        y_start,
        y_step,
    ...
    static getTgaRGBA(header, data, width, height, image, palette, use_grey) {
        ...
        if (use_grey) {
            switch (header.pixel_size) {
                case 8:
                    TGALoader.tgaGetImageDataGrey8bits(
                        header,
                        data,
                        y_start,
                        y_step,
                    ...
                    break;
                case 16:
                    TGALoader.tgaGetImageDataGrey16bits(
                        header,
                        data,
                        y_start,
                        y_step,
            ...
            switch (header.pixel_size) {
                case 8:
                    TGALoader.tgaGetImageData8bits(
                        header,
                        data,
                        y_start,
                        y_step,
                    ...
                    break;
                case 16:
                    TGALoader.tgaGetImageData16bits(
                        header,
                        data,
                        y_start,
                        y_step,
                    ...
                    break;
                case 24:
                    TGALoader.tgaGetImageData24bits(
                        header,
                        data,
                        y_start,
                        y_step,
                    ...
                    break;
                case 32:
                    TGALoader.tgaGetImageData32bits(
                        header,
                        data,
                        y_start,
                        y_step,
