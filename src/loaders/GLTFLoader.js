...
import RequirementsTracer, { MODELS_REQUIREMENTS, REQUIREMENTS_EVENTS } from "./RequirementsTracer";

export const buildGLTFLoader = () => {
    ...
    var GLTFLoader = (function () {
        ...
        GLTFParser.prototype.loadBuffer = function (bufferIndex) {
            ...
            const url = binary || resolveURL(bufferDef.uri, options.path);

            return new Promise(function (resolve, reject) {
                loader.load(url, resolve, undefined, function () {
                    tracer.trace(MODELS_REQUIREMENTS.BINARY);
                    reject(
                        new Error(
        ...
        GLTFParser.prototype.loadTexture = function (textureIndex) {
            ...
            return Promise.resolve(sourceURI)
                .then(function (sourceURI) {
                    ...
                    return new Promise(function (resolve, reject) {
                        const texturePath = options.texture || resolveURL(sourceURI, options.path);
                        loader.load(texturePath, resolve, undefined, err => {
        ...
        GLTFParser.prototype.assignFinalMaterial = function (mesh) {
            ...
            if (material.isGLTFSpecularGlossinessMaterial) {
                ...
                mesh.onBeforeRender =
                    extensions[EXTENSIONS.KHR_MATERIALS_PBR_SPECULAR_GLOSSINESS].refreshUniforms;
            }
        ...
        GLTFParser.prototype.loadMaterial = function (materialIndex) {
            ...
            if (materialDef.occlusionTexture !== undefined && materialType !== MeshBasicMaterial) {
                pending.push(
                    parser.assignTexture(materialParams, "aoMap", materialDef.occlusionTexture),
                );
    ...
    return { tracer, loader: new GLTFLoader() };
};
