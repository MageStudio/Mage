...
var GLTFLoader = (function () {
    ...
    GLTFParser.prototype.loadBuffer = function (bufferIndex) {
        ...
        return new Promise(function (resolve, reject) {
            loader.load(url, resolve, undefined, function () {
                reject(
                    new Error('THREE.GLTFLoader: Failed to load buffer "' + bufferDef.uri + '".'),
                );
            });
        });
    };
        ...
        if (
            ...
            if (!cachedMaterial) {
                cachedMaterial = material.isGLTFSpecularGlossinessMaterial
                    ? extensions[EXTENSIONS.KHR_MATERIALS_PBR_SPECULAR_GLOSSINESS].cloneMaterial(
                          material,
                      )
                    : material.clone();
    ...
    GLTFParser.prototype.loadAnimation = function (animationIndex) {
        ...
        return Promise.all([
            ...
            var name =
                animationDef.name !== undefined ? animationDef.name : "animation_" + animationIndex;
