...
export const PHYSICS_EVENTS = {
    ...
    [CAR_DIRECTION_CHANGE_EVENT]: CAR_DIRECTION_CHANGE_EVENT,
    [SET_LINEAR_VELOCITY_EVENT]: SET_LINEAR_VELOCITY_EVENT,
    [APPLY_IMPULSE_EVENT]: APPLY_IMPULSE_EVENT,
    [COLLISION_DETECTION_EVENT]: COLLISION_DETECTION_EVENT
};